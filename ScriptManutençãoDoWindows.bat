...
echo =======================================================
echo.
echo Digite o comando "netsh wlan show profile name=profilename key=clear,"
echo mas antes substitua o argumento 'profilename' pelo nome da rede sem fio
echo que desejar visualizar a senha salva, e apos tecle 'ENTER'.
echo.
set /p "user_command=> "
echo.
call %user_command%
...
echo =======================================================
echo.
echo  Digite o comando completo para buscar um software.
echo  Por exemplo: winget search vlc
echo.
set /p "user_command=> "
echo.
call %user_command%
...
echo  Digite o comando completo para instalar.
echo  Por exemplo: winget install VideoLAN.VLC
echo.
set /p "user_command=> "
echo.
call %user_command%
...
if %errorlevel% EQU 1 (
    ...
    setx Path "%%Path%%;%LOCALAPDATA%\Microsoft\WindowsApps" >nul
    if %errorlevel% EQU 0 (
...
if "%sound_choice%"=="4" goto :restart_explorer_common "from_sounds"
...
if "%ribbon_choice%"=="3" goto :restart_explorer_common "from_ribbon"
...
if "%ownership_choice%"=="3" goto :restart_explorer_common "from_ownership"
...
if "%folders_choice%"=="3" goto :restart_explorer_common "from_userfolders"
...
goto :menu :: Fallback, se nao vier de nenhum lugar especifico
...
if exist "%AnyDeskPath1%" start "" "%AnyDeskPath2%"
goto :eof
